...
const icon = {
    icon: {
        svg: (
            <G>
                <Path d="M7.444 15.674L.228 8.543a.761.761 0 0 1 0-1.086L7.444.326a1.136 1.136 0 0 1 1.593
...
const BackArrowIcon = props => <SvgIcon fill={iconColor} height={16} width={9.37} name={'icon'} {...props}
