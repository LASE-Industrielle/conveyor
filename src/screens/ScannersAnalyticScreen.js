        ...
        <View style={{backgroundColor: 'transparent', width: '100%', height: '100%'}}>
            ...
            >
                ...
                >
                    ...
                    <GraphComponent lineColor={orangeGraph} loading={false} label={'Volume Sum'}
                                    data={volumeSumMeasurements} ticks={volumeSumMeasurementsTicks}
                                    value={volumeSum}
                                    units={'dm\u00B3'}/>}

                    {volumeFlowMeasurements &&
                    <GraphComponent lineColor={blueGraph} loading={false} label={'Volume Flow Rate'}
                                    data={volumeFlowMeasurements} ticks={volumeFlowMeasurementsTicks}
                                    value={avgVolumeFlow}
                                    units={'dm\u00B3/h'}/>}

                    {conveyorSpeedMeasurements &&
                    <GraphComponent lineColor={redGraph} loading={false} label={'Conveyor Speed'}
                                    data={conveyorSpeedMeasurements} ticks={conveyorSpeedMeasurementsTicks}
                                    value={conveyorSpeed}
                                    units={'mm/s'}/>}
                </View>
            </ScrollView>
