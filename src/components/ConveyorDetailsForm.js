...
const ConveyorDetailsForm = ({ conveyor }) => (
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <FormLineComponent />
    <ConveyorDetailsFormRow title="Conveyor Speed" item1={conveyor.latest_measurement.conveyor_speed} item2="mm/s" />
    <FormLineComponent />
    <ConveyorDetailsFormRow
    ...
    />
    <FormLineComponent />
    <ConveyorDetailsFormRow title="Volume Sum" item1={conveyor.latest_measurement.volume_sum} item2={'dm\u00B3'} />
    <FormLineComponent />
    <ConveyorDetailsFormRow
